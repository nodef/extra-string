...
const ORIGINAL = 'Original module: [extra-string].';
...
function pkgMinify(o) {
  ...
  readme = readme.replace(/extra-string\.min/g, 'extra-string');
  readme += `[unpkg]: https://unpkg.com/extra-string.min${EOL}`;
  readme += `[jsDelivr]: https://cdn.jsdelivr.net/npm/extra-string.min${EOL}`;
  pkg.name += '.min';
